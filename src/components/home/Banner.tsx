    ...
    return (
        <main className="w-full flex py-[100px] bg-orange-200 shadow-xl shadow-slate-600 " >
            <section className="w-1/2 ml-[180px] pl-[100px]">
                ...
                <br />
                <p className="text-red-800 font-sans font-bold text-base">If you are going to use a passage of Lorem Ipsum, you need to be <br /> sure there isnt anything embarrassing hidden in the middle of text.</p>
